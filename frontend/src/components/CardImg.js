            ...
            <Row>
                ...
                <Col span={15} style={{ paddingRight: 8 }}>
                    ...
                    <Link to={`/posts/${post.slug}`} style={{ textDecoration: 'none' }}>
                        <Title className="title-card" level={4} style={{ lineHeight: 1.15 }} ellipsis={{ rows: 3 }}>
                            {post.title}
                        </Title>
                    </Link>
                ...
                <Col span={7} >
                    ...
                    <Link to={`/posts/${post.slug}`}>
                        <Image style={{ borderRadius: 2, objectFit: 'cover' }} preview={false} width={187} height={134} src={imageUrl}
